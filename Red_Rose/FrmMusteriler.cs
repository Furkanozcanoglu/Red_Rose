...
namespace Red_Rose
{
    public partial class FrmMusteriler : Form
    {
        ...
        private void BtnVerileriGoster_Click(object sender, EventArgs e)//güncelleme
        {
            verilerigoster();
        }
        int id = 0;
        private void BtnSil_Click(object sender, EventArgs e)
        {
            ...
            {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("delete from Oda101_1", baglanti);
...
//Data Source=FURKAN;Initial Catalog=RedRosePansiyon;Integrated Security=True
//daha sonra güncelleme bölümünde tarihi değişince parayı da güncelleme yap.
//SqlCommand komut = new SqlCommand("delete from MusteriEkle where Musteriid=(" + id + ")", baglanti);
//daha sonra verileri güncelleyince sql tablosunda ki oda ismi de değişsin