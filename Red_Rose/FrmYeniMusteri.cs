       ...
       private void BtnOda101_Click(object sender, EventArgs e)
        {
            TxtOdaNo.Text = "101";
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Oda101_1 (Adi,Soyadi) values ('" + TxtAdi.Text + "','" + TxtSoyadi.Text + "')",baglanti);
        ...
        private void FrmYeniMusteri_Load(object sender, EventArgs e)
        {
            ///
            baglanti.Open();
            SqlCommand komut1 = new SqlCommand("select * from Oda101_1", baglanti);
            SqlDataReader oku1 = komut1.ExecuteReader();
            while (oku1.Read())
            {
                BtnOda101_1.Text = oku1["Adi"].ToString() + " " +
                                 oku1["Soyadi"].ToString();
            }
            baglanti.Close();
            if (BtnOda101_1.Text != "101")
            {
                BtnOda101_1.BackColor = Color.Red;
                BtnOda101_1.Enabled = false;
            }
            ///
            baglanti.Open();
            ...
            while (oku2.Read())
            {
                BtnOda102.Text = oku2["Adi"].ToString() + " " +
                                 oku2["Soyadi"].ToString();
            }
            baglanti.Close();
            ...
            while (oku3.Read())
            {
                BtnOda103.Text = oku3["Adi"].ToString() + " " +
                                 oku3["Soyadi"].ToString();
            }
            baglanti.Close();
            ...
            while (oku4.Read())
            {
                BtnOda104.Text = oku4["Adi"].ToString() + " " +
                                 oku4["Soyadi"].ToString();
            }
            baglanti.Close();
            ...
            while (oku5.Read())
            {
                BtnOda105.Text = oku5["Adi"].ToString() + " " +
                                 oku5["Soyadi"].ToString();
            }
            baglanti.Close();
            ...
            while (oku6.Read())
            {
                BtnOda106.Text = oku6["Adi"].ToString() + " " +
                                 oku6["Soyadi"].ToString();
            }
            baglanti.Close();
            ...
            while (oku7.Read())
            {
                BtnOda107.Text = oku7["Adi"].ToString() + " " +
                                 oku7["Soyadi"].ToString();
            }
            baglanti.Close();
            ...
            while (oku8.Read())
            {
                BtnOda108.Text = oku8["Adi"].ToString() + " " +
                                 oku8["Soyadi"].ToString();
            }
            baglanti.Close();
            ...
            while (oku9.Read())
            {
                BtnOda109.Text = oku9["Adi"].ToString() + " " +
                                 oku9["Soyadi"].ToString();
            }
            baglanti.Close();
...
//Data Source=FURKAN;Initial Catalog=RedRosePansiyon;Integrated Security=True;Trust Server Certificate=True