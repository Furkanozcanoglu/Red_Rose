...
namespace Red_Rose
{
    public partial class FrmGelirGider : Form
    {
        ...
        private void FrmGelirGider_Load(object sender, EventArgs e)
        {
            ...
            //İcecekler
            baglanti.Open();
            SqlCommand komut3 = new SqlCommand("select sum (icecekler) as toplam2 from Stoklar1", baglanti);
            ...
            //Atistirmaliklar
            baglanti.Open();
            SqlCommand komut4 = new SqlCommand("select sum (Atistirmaliklar) as toplam3 from Stoklar1", baglanti);
            ...
            //Elektrik
            baglanti.Open();
            SqlCommand komut5 = new SqlCommand("select sum (Elektrik) as toplam4 from Faturalar1", baglanti);
            ...
            //Su
            baglanti.Open();
            SqlCommand komut6 = new SqlCommand("select sum (Su) as toplam5 from Faturalar1", baglanti);
            ...
            //internet
            baglanti.Open();
            SqlCommand komut7 = new SqlCommand("select sum (internet) as toplam6 from Faturalar1", baglanti);
